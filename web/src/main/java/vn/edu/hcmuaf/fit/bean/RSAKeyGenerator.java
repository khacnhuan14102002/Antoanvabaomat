...
public class RSAKeyGenerator  {
    ...
    public static void main(String[] args) throws Exception {
        ...
        kp= rsa.genKeyPair();
        PublicKey pb ;
        pb = rsa.genPublicKey(kp);
//        System.out.println(pb);
        PrivateKey pv;
        pv = rsa.genPrivateKey(kp);
//        String pbString = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCRR7I8IPXcVUEWQYiH4CD3Q/CLuFq3DbUB3CnMK6QREbVgf1b5EMtofFeOtIdJS+jw4+NJetLQGm0VLpTn8pOhptbCSD06pYQGggHH6un2T60zySrmZFXvfjqIYcA+gpvgT01raBhRdifU5Vq4tF1nusjyxPdcD9f4utsvVgJaUQIDAQAB";
//        System.out.println(rsa.getPublicKeyFromString(pbString));
        System.out.println(rsa.privateKeyToString(pv));
    }
}